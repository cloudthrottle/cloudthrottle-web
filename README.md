...
USER_EMERGENCY_STOP --> UPDATE_THROTTLE_STATE
...
IMPORT_LOCOS --> ADD_OR_UPDATE_LOCO
...
COMMAND_SEND --> ADD_COMMAND_TO_LOG : TODO
COMMAND_RECEIVED --> ADD_COMMAND_TO_LOG : TODO
note right of ADD_COMMAND_TO_LOG
TODO
end note
```