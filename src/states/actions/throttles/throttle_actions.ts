...
export const userChangedButtonValue = createAction<{
    loco: Loco,
    name: number,
    value: BitValue
}>('USER_CHANGED_BUTTON_VALUE')

export const userUpdateThrottleState = createAction<{
    loco: Loco,
    throttle: Partial<ThrottleState>
}>('USER_UPDATE_THROTTLE_STATE')
export const updateThrottleState = createAction<{
    loco: Loco,
    throttle: Partial<ThrottleState>
}>('UPDATE_THROTTLE_STATE')
export const userUpdateFunctionButtonState = createAction<{
    loco: Loco,
    functionButtons: PartialFunctionButtons
}>('USER_UPDATE_FUNCTION_BUTTON_STATE')
export const updateFunctionButtonState = createAction<{
    loco: Loco,
    functionButtons: PartialFunctionButtons
}>('UPDATE_FUNCTION_BUTTON_STATE')
export const createThrottleCommand = createAction<{
    loco: Loco,
    throttle: Partial<ThrottleState>
}>('CREATE_THROTTLE_COMMAND')
export const createCabCommand = createAction<{
    loco: Loco,
    functionButtons: PartialFunctionButtons
}>('CREATE_CAB_COMMAND')
